...
const Cart = () => {
  ...
  if (carts.length === 0) {
    return (
      <div className='h-[55vh] flex flex-col justify-center items-center text-4xl'>
        <h1>Cart is empty...</h1>
        <br />
        <h3>
      ...
      <div className="flex shadow-md my-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="border-t mt-8">
            ...
            <button className="bg-green-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Checkout</button>
          </div>
        </div>
